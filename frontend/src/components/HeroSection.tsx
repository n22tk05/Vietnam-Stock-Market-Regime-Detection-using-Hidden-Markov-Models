        ...
        <div className="lg:col-span-7 z-10">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-10">
            ...
            <button
              ...
              className="bg-slate-100 hover:bg-slate-200/80 text-slate-800 font-bold text-base px-8 py-4 rounded-2xl flex items-center gap-2.5 transition-all border border-slate-200/60"
            >
              <span>Xem demo</span>
